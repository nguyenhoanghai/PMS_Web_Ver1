...
GPRO.namespace('TiLeCat');
GPRO.TiLeCat = function () {
    var Global = {
        UrlAction: {
            Gets: '/Light/Gets',
            Save: '/Light/Save',
    ...
    function Gets() {
        $.ajax({
            ...
            type: 'POST',
            data: JSON.stringify({ 'lightType': 1  }),
    ...
    function DrawTable(objs) {
        Global.Data.table=  $("#tbCat").DataTable({
        ...
        btnAdd.insertBefore('#tbCat_filter');
    }     
