...
GPRO.namespace('LCDHoanTat3');
GPRO.LCDHoanTat3 = function () {
    var Global = {
        UrlAction: {
                        ...
                        case 'tblpanelHeader':
                            switch (parseInt(v.ColumnInt)) {
                                case 1:
                                    ...
                                    var css = "#" + Global.Data.tableId + " #header .value1 {width:" + (v.SizePercent - 0.2) + "%;}";
                                    sheet.innerHTML = css;
                                ...
                                case 2:
                                    ...
                                    var sheet = document.createElement('style')
                                    var css = "#" + Global.Data.tableId + " #header .value2 {width:" + (v.SizePercent - 0.2) + "%;}";
                                    sheet.innerHTML = css;
                                    document.body.appendChild(sheet);
                                    break;
                                case 3:
                                    ...
                                    var sheet = document.createElement('style')
                                    var css = "#" + Global.Data.tableId + " #header .value3 {width:" + (v.SizePercent - 0.2) + "%;}";
                                    sheet.innerHTML = css;
                                    document.body.appendChild(sheet);
                                    break;
                                case 4:
                                    ...
                                    var sheet = document.createElement('style')
                                    var css = "#" + Global.Data.tableId + " #header .value4 {width:" + (v.SizePercent - 0.2) + "%;}";
                                    sheet.innerHTML = css;
                                    document.body.appendChild(sheet);
                                    break;
                                case 5:
                                    ...
                                    var sheet = document.createElement('style')
                                    var css = "#" + Global.Data.tableId + " #header .value5 {width:" + (v.SizePercent - 0.2) + "%;}";
                                    sheet.innerHTML = css;
                                    document.body.appendChild(sheet);
                                    break;
                                case 6:
                                    ...
                                    var sheet = document.createElement('style')
                                    var css = "#" + Global.Data.tableId + " #header .value6 {width:" + (v.SizePercent) + "%;}";
                                    sheet.innerHTML = css;
                                    document.body.appendChild(sheet);
                                    break;
                            }
