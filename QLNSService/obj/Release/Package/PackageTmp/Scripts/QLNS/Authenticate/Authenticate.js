    ...
    function Login() {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, xhr) {
                $('#loading').hide();
                if (data.Result == "OK") {
                    //Cookies.set('LineIds', data.Data.LineIds_Str, { expires: 7 });
                    //Cookies.set('LoginUser', JSON.stringify(data.Data), { expires: 1 });
                    setCookie('strLineIds', data.Data.LineIds_Str, 2);
                    setCookie('LoginUser',JSON.stringify(data.Data), 2 );
