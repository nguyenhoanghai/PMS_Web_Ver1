...
GPRO.LCDKanBan = function () {
    ...
    function GetProductivity() {
        $.ajax({
            ...
            type: 'POST',
            data: JSON.stringify({ 'listLineId': Global.Data.ListLineId, 'tableTypeId': Global.Data.TableType,'includeBTPHC':false }),
    ...
    function DrawContentAndSetData(datas) {
        ...
        $.each(datas, function (i, obj) {
            ...
            $ul.append('<li class="value value3 font-dt"><span>' + obj.BTPOnDay + '</span></li>');
            $ul.append('<li class="value value4 font-dt"><span>' + obj.ProductionPlans + '<span class="blue">|</span>' + obj.LK_BTP_HC + '</span></li>');
            // $ul.append('<li class="value value5 font-dt"><span>' + obj.BTPBinhQuan + '<span class="blue">|</span>' + obj.BTPInLine + '</span></li>');  
            $ul.append('<li class="value value5 font-dt"><span>' + obj.LK_BTP + '<span class="blue">|</span>' + (obj.BTPInLine < 0 ? 0 : obj.BTPInLine) + '</span></li>');
    ...
    function SetDataWithoutDrawContent(datas) {
        $.each(datas, function (i, obj) {
            $('#tbKB .r_' + i + ' .value1').html('<span>' + obj.LineName + '</span>');
            $('#tbKB .r_' + i + ' .value2').html('<span>' + (obj.ProductName.length > 8 ? (obj.ProductName.substring(0, 8) + '...') : obj.ProductName) + '</span>');
            $('#tbKB .r_' + i + ' .value3').html('<span>' + obj.BTPOnDay + '</span>');
            $('#tbKB .r_' + i + ' .value4').html('<span>' + obj.ProductionPlans + '<span style="color:blue">|</span>' + obj.LK_BTP_HC + '</span>');
            //  $('#tbKB .r_' + i + ' .value5').html('<span>' + obj.BTPBinhQuan + '<span style="color:blue">|</span>' + obj.BTPInLine + '</span>');  
            $('#tbKB .r_' + i + ' .value5').html('<span>' + obj.LK_BTP + '<span style="color:blue">|</span>' + obj.BTPInLine + '</span>');
